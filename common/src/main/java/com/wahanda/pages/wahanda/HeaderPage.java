...
import com.wahanda.utility.AbstractTest;
...
public class HeaderPage {
    ...
    public void login(AccountForm accountForm) {
        ...
        AbstractTest.utility.click(getLogInButton());
        AbstractTest.utility.enterText(getEmailTextBox(), accountForm.getEmail());
        AbstractTest.utility.enterText(getPasswordTextBox(), accountForm.getPassword());
        AbstractTest.utility.click(getSubmitLoginButton());

        LOG.info("Logged in as " + accountForm.getEmail());
    }

    public void logout() {
        AbstractTest.utility.click(getControlOpen());
        AbstractTest.utility.click(getLogOutButton());
        AbstractTest.utility.waitForElementToBeVisible(getLogInButton());
