        ...
        try {
            switch (element.getLocator()) {
                case CSS:
                    ...
                    if (!AbstractTest.driver.findElement(By.cssSelector(element.getLocatorString())).getAttribute("value").equals(text) && AbstractTest.browserDescription.contains("safari")) {
                ...
                case ID:
                    ...
                    if (!AbstractTest.driver.findElement(By.id(element.getLocatorString())).getAttribute("value").equals(text) && AbstractTest.browserDescription.contains("safari")) {
                        LOG.error(AbstractTest.browserDescription + "Entering text failed. Found '" + AbstractTest.driver.findElement(By.id(element.getLocatorString())).getText().equals(text) + "' Retrying");
                        clearAndEnterText(element, new StringBuilder(text).reverse().toString());
                    }
                    break;
                case XPATH:
                    AbstractTest.driver.findElement(By.xpath(element.getLocatorString())).sendKeys(text);
                    if (!AbstractTest.driver.findElement(By.xpath(element.getLocatorString())).getAttribute("value").equals(text) && AbstractTest.browserDescription.contains("safari")) {
                        LOG.error(AbstractTest.browserDescription + "Entering text failed. Found '" + AbstractTest.driver.findElement(By.xpath(element.getLocatorString())).getText().equals(text) + "' Retrying");
                        clearAndEnterText(element, new StringBuilder(text).reverse().toString());
                    }
                    break;
                case LINKTEXT:
                    AbstractTest.driver.findElement(By.linkText(element.getLocatorString())).sendKeys(text);
                    if (!AbstractTest.driver.findElement(By.linkText(element.getLocatorString())).getAttribute("value").equals(text) && AbstractTest.browserDescription.contains("safari")) {
                        LOG.error(AbstractTest.browserDescription + "Entering text failed. Found '" + AbstractTest.driver.findElement(By.linkText(element.getLocatorString())).getText().equals(text) + "' Retrying");
                        clearAndEnterText(element, new StringBuilder(text).reverse().toString());
                    }
                    break;
                case NAME:
                    AbstractTest.driver.findElement(By.name(element.getLocatorString())).sendKeys(text);
                    if (!AbstractTest.driver.findElement(By.name(element.getLocatorString())).getAttribute("value").equals(text) && AbstractTest.browserDescription.contains("safari")) {
                        LOG.error(AbstractTest.browserDescription + "Entering text failed. Found '" + AbstractTest.driver.findElement(By.name(element.getLocatorString())).getText().equals(text) + "' Retrying");
                        clearAndEnterText(element, new StringBuilder(text).reverse().toString());
                    }
                    break;
            }
